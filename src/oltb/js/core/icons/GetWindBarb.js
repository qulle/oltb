...
const getSVGPath = function(windSpeed) {
         if(windSpeed >= 0.0  && windSpeed < 1.0)  return WindBarb.knot0;
    else if(windSpeed >= 1.0  && windSpeed < 2.5)  return WindBarb.knot2;
    else if(windSpeed >= 2.5  && windSpeed < 5.0)  return WindBarb.knot5;
    else if(windSpeed >= 5.0  && windSpeed < 7.5)  return WindBarb.knot10;
    else if(windSpeed >= 7.5  && windSpeed < 10.0) return WindBarb.knot15;
    else if(windSpeed >= 10.0 && windSpeed < 12.5) return WindBarb.knot20;
    else if(windSpeed >= 12.5 && windSpeed < 15.0) return WindBarb.knot25;
    else if(windSpeed >= 15.0 && windSpeed < 17.5) return WindBarb.knot30;
    else if(windSpeed >= 17.5 && windSpeed < 20.0) return WindBarb.knot35;
    else if(windSpeed >= 20.0 && windSpeed < 22.5) return WindBarb.knot40;
    else if(windSpeed >= 22.5 && windSpeed < 25.0) return WindBarb.knot45;
    else if(windSpeed >= 25.0 && windSpeed < 27.5) return WindBarb.knot50;
    else if(windSpeed >= 27.5 && windSpeed < 30.0) return WindBarb.knot55;
    else if(windSpeed >= 30.0 && windSpeed < 32.5) return WindBarb.knot60;
    else if(windSpeed >= 32.5 && windSpeed < 35.0) return WindBarb.knot65;
    else if(windSpeed >= 35.0 && windSpeed < 37.5) return WindBarb.knot70;
    else if(windSpeed >= 37.5 && windSpeed < 40.0) return WindBarb.knot75;
    else if(windSpeed >= 40.0 && windSpeed < 42.5) return WindBarb.knot80;
    else if(windSpeed >= 42.5 && windSpeed < 45.0) return WindBarb.knot85;
    else if(windSpeed >= 45.0 && windSpeed < 47.5) return WindBarb.knot90;
    else if(windSpeed >= 47.5 && windSpeed < 50.0) return WindBarb.knot95;
    else if(windSpeed >= 50.0 && windSpeed < 52.5) return WindBarb.knot100;
    else if(windSpeed >= 52.5 && windSpeed < 55.0) return WindBarb.knot105;
    else if(windSpeed >= 55.0 && windSpeed < 57.5) return WindBarb.knot110;
    else if(windSpeed >= 57.5 && windSpeed < 60.0) return WindBarb.knot115;
    else if(windSpeed >= 60.0 && windSpeed < 62.5) return WindBarb.knot120;
    else if(windSpeed >= 62.5 && windSpeed < 65.0) return WindBarb.knot125;
    else if(windSpeed >= 65.0 && windSpeed < 67.5) return WindBarb.knot130;
    else if(windSpeed >= 67.5 && windSpeed < 70.0) return WindBarb.knot135;
    else if(windSpeed >= 70.0 && windSpeed < 72.5) return WindBarb.knot140;
    else if(windSpeed >= 72.5 && windSpeed < 75.0) return WindBarb.knot145;
    else if(windSpeed >= 75.0 && windSpeed < 77.5) return WindBarb.knot150;
    else if(windSpeed >= 77.5 && windSpeed < 80.0) return WindBarb.knot155;
    else if(windSpeed >= 80.0 && windSpeed < 82.5) return WindBarb.knot160;
    else if(windSpeed >= 82.5 && windSpeed < 85.0) return WindBarb.knot165;
    else if(windSpeed >= 85.0 && windSpeed < 87.5) return WindBarb.knot170;
    else if(windSpeed >= 87.5 && windSpeed < 90.0) return WindBarb.knot175;
    else if(windSpeed >= 90.0 && windSpeed < 92.5) return WindBarb.knot180;
    else if(windSpeed >= 92.5 && windSpeed < 95.0) return WindBarb.knot185;
    else if(windSpeed >= 95.0 && windSpeed < 97.5) return WindBarb.knot190;
    else return WindBarb.knot0;
}
