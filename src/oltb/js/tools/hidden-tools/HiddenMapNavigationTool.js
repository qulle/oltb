            ...
            const infoWindow = {
                ...
                footer: `
                    ...
                    <div class="oltb-info-window__buttons-wrapper">
                        ...
                        <button class="${CLASS_FUNC_BUTTON} ${CLASS_FUNC_BUTTON}--copy oltb-tippy" title="Copy marker text" id="${ID_PREFIX_INFO_WINDOW}-copy-text" data-copy="${markerData.title}, ${markerData.description}"></button>
                    </div>
                `
            };
