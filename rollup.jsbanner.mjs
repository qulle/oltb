 ...
 * | (+) Parcel 2.9.2                       - (https://parceljs.org/)                                                |
 * | (+) @parcel/transformer-sass 2.9.2     - (https://github.com/parcel-bundler/parcel)                             |
 * | (+) Rollup 3.25.1                      - (https://github.com/rollup/rollup)                                     |
 * | (+) @rollup/plugin-commonjs 25.0.2     - (https://github.com/rollup/plugins/tree/master/packages/commonjs)      |
 * | (+) @rollup/plugin-json 6.0.0          - (https://github.com/rollup/plugins/tree/master/packages/json)          |
 * | (+) @rollup/plugin-node-resolve 15.1.0 - (https://github.com/rollup/plugins/tree/master/packages/node-resolve)  |
 * | (+) @rollup-plugin-replace 5.0.2       - (https://github.com/rollup/plugins/tree/master/packages/replace)       |
 * | (+) @rollup/plugin-terser 0.4.3        - (https://github.com/rollup/plugins/tree/master/packages/terser)        |
