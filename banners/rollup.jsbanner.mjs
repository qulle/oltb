 ...
 * +--------------------------------------------------------------------------------------------------------------+
 * | Project: OLTB                                                                                                |
 * | Version: v3.0.0-dev https://github.com/qulle/oltb#readme                                                     |
 * |    Date: 2024-05-10 23:00                                                                                    |
 * |  Author: Qulle https://github.com/qulle                                                                      |
 * | License: BSD-2-Clause license https://github.com/qulle/oltb/blob/main/LICENSE                                |
 * + -------------------------------------------------------------------------------------------------------------+
 * | Thanks to the following projects:                                                                            |
 * | (+) OpenLayers 10.0.0                  - https://openlayers.org                                              |
 * | (+) proj4 2.11.0                       - http://proj4js.org                                                  |
 ...
 * | (+) JSTS 2.11.3                        - https://github.com/bjornharrtell/jsts                               |
 * | (+) Parcel 2.12.0                      - https://parceljs.org                                                |
 * | (+) @parcel/transformer-sass 2.12.0    - https://github.com/parcel-bundler/parcel                            |
 * | (+) Rollup 4.19.1                      - https://github.com/rollup/rollup                                    |
 * | (+) @rollup/plugin-commonjs 26.0.1     - https://github.com/rollup/plugins/tree/master/packages/commonjs     |
 ...
 * | (+) @rollup-plugin-replace 5.0.7       - https://github.com/rollup/plugins/tree/master/packages/replace      |
 * | (+) @rollup/plugin-terser 0.4.4        - https://github.com/rollup/plugins/tree/master/packages/terser       |
 * | (+) rollup-plugin-license 3.5.2        - https://github.com/mjeanroy/rollup-plugin-license                   |
 ...
 * | (+) Sortable JS 1.15.2                 - https://github.com/SortableJS/Sortable                              |
 * | (+) UUID JS 10.0.0                     - https://github.com/uuidjs/uuid                                      |
 * | (+) Lodash 4.17.21                     - https://github.com/lodash/lodash                                    |
 * | (+) Many Keys Map 2.0.1                - https://github.com/fregante/many-keys-map                           |
 * | (+) ESLint 9.8.0                       - https://github.com/eslint/eslint                                    |
 * | (+) @eslint/js 9.2.0                   - https://github.com/eslint/eslint                                    |
 * | (+) Husky 9.1.3                        - https://github.com/typicode/husky                                   |
 * | (+) Lint Staged 15.2.7                 - https://github.com/lint-staged/lint-staged                          |
 ...
 * | (+) Axios 1.7.2                        - https://github.com/axios/axios                                      |
 * +--------------------------------------------------------------------------------------------------------------+
 */`;